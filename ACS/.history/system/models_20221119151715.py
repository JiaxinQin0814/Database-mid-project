...
class teaching_class_classroom_time_assignment(models.Model):
    ...
    teaching_id = models.ForeignKey(teaching_class,on_delete=models.CASCADE,verbose_name="教学班",blank=False)
    time = models.ForeignKey(TC,blank=False,on_delete=models.CASECADE)
