...
class teaching_class_classroom_time_assignment(models.Model,TC):
    ...
    time = models.ForeignKey(TC,blank=Fals÷e,on_delete=models.CASCADE,related_name="relation_time",verbose_name="教学班上课时间")
...
class teaching_class_teacher_time_assignment(models.Model,TC):
