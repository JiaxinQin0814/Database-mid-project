...
class major_class(models.Model):
    ...
    major = models.ForeignKey(Major,null=True,blank=True,on_delete=models.CASCADE,related_name="班级所属专业")
    Big_Lei = models.ForeignKey(Major,null=True,blank=True,on_delete=models.CASCADE,related_name="班级所属大类")
    school =models.ForeignKey(School,null=True,blank=True,on_delete=models.CASCADE,related_name="班级所属院系")
    belongs_to_a_major = models.BooleanField(blank=False,default=True) # 如果是True 就是一个专业，否则是一个大类
    class Meta:
...
class Classroom(models.Model):
    ...
    place = models.ForeignKey(Building,null=True,blank=True,on_delete=models.CASCADE,related_name="教室所在教学楼")
    is_engine_room = models.BooleanField(verbose_name="是否机房",default=f)