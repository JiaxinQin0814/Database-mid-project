...
class Source_class(models.Model):
    ...
    character1 = models.CharField(max_length=30,blank=True,choices=module1.choices,default=module1.ZYJY,verbose_name="一级模块")
    character2 = models.CharField(max_length=30,blank=True,choices=module2.choices,default=module2.SXZZLL,verbose_name="二级模块")
    school =models.ForeignKey(School,null=True,blank=True,on_delete=models.CASCADE,related_name="school_class-relation",verbose_name="开课院系")
