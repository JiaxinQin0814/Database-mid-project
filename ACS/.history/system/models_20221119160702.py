...
class Teacher_Info(models_.Model):
   teacherid = models.OneToOneField(User,on_delete=models.CASCADE,primary_key=True,verbose_name="教师编号")
...
class Ad_Info(models.Model):
    id = models.OneToOneField(User,on_delete=models.CASCADE,primary_key=True,null=False,verbose_name="教秘编号")
