...
class TC(models.Model):
    ...
    def __init__(self,week,weekday,jieke):
        self.Week = models.IntegerField(verbose_name="周次",validators=[MaxValueValidator(20),MinValueValidator(1)])
class Time_class_Field(models.Field):
    description = "The time of a class"
    # def __init__(self,*args,**kwargs):
    #     super().__init__(*args,**kwargs)
    # def db_type(self,connection):
    #     return "time_class_field"
