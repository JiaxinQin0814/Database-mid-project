...
# class TC(models.Field):
#     def __init__(self,week,weekday,class_number,*args,**kwargs):
...
class Teacher_Info(models.Model):
   Teacher_Id = models.OneToOneField(User,on_delete=models.CASCADE,primary_key=True,verbose_name="教师编号")
...
class Admin_Info(models.Model):
    ...
    Admin_Id = models.OneToOneField(User,on_delete=models.CAS)
