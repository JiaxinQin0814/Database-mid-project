...
class Source_class(models.Model):
    ...
    class_name = models.CharField(max_length=30,blank=False,verbose_name="课程名称")
    credit = models.IntegerField(verbose_name="学分",default=2,validators=[MaxValueValidator(20),MinValueValidator()])