...
class teaching_class_teacher_time_assignment(models.Model):
    relation_id = models.AutoField(primary_key=True,verbose_name="教学班_教师-时间关系")
    teaching_class_id  = models.ForeignKey(teaching_class,on_delete=models.CASCADE,related_name="relation_teachingid",verbose_name="教学班",blank=False)
    time = models.ForeignKey(TC,blank=True,on_delete=models.CASCADE,related_name="relation_time",verbose_name="教学班上课时间")
    ...
    def __str__(self):
        return "教学班%s,时间:%s,教师:"%(self.teaching_class_id,self.time,self.teacher)
