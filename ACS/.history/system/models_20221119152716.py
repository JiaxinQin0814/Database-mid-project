...
class teaching_class_teacher_time_assignment(models.Model):
    ...
    time = models.ForeignKey(TC,blank=,on_delete=models.CASCADE,related_name="relation-time",verbose_name="教学班上课时间")
    teacher = models.ForeignKey(Teacher_Info,blank=True)
