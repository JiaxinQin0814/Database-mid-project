...
#    school = models.CharField(max_length=20,verbose_name="隶属院系")
   school =models.ForeignKey(School,blank==True,on_delete=models.SET_NULL,related_name="教师所属院系")
...
class Admin_Info(models.Model):
    ...
    password = models.CharField(max_length=30, blank=False, verbose_name="密码")
    school = models.CharField(max_length=20,verbose_name="隶属院系",null=True)
...
#     character1 = models.CharField(max_length=30,choice=module,verbose_name="一级模块")
#     character2 = models.CharField(max_length=30,choice=module,verbose_name="二级模块")
...
# class major_class(models.Model):
    ...
    # school = models.CharField(max_length=30,verbose_name="学院名称")